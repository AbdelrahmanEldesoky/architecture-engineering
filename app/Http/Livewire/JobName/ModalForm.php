...
class ModalForm extends Modal
{
    ...
    public $jobName ;
    public $name , $job_type_id , $jobTypes ,$description;
    ...
    public function save()
    {
        ...
        $this->reset('name','active','job_type_id','description');
    ...
    {
        $this->loading = true ;
        $this->reset('job_type_id','name','active','jobName','description');
        $this->title = 'create';
        $this->button = 'save';
        $this->color = 'primary';
        $this->open();
//        sleep(.5);
    ...
    {
        $this->loading = true ;
        $this->reset('jobName','name','active','job_type_id','description');
