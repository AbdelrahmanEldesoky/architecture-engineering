...
class StepFour extends BasicForm
{
    ...
    public function mount($employee_id = null) {
        ...
        $this->vacation['date_of_hiring']=$emp->contract->join_date;
       $this->updateDues();
    ...
    public function close($modal_id)
    {
            ...
            return redirect()->route('admin.custom.create', [
    ...
    public function updateDues() {
        $this->reset("dues");
         ...
         $EmployeeInfo = EmployeeInfo::where('employee_id',$this->employee_id)->first();
         $this->end_medical_insurance = $EmployeeInfo->end_medical_insurance; 
    ...
    public function addDues() {
       ...
       if(empty($this->dues)) {
        ...
        $EmployeeInfo = EmployeeInfo::where('employee_id',$this->employee_id)->first();
        $EmployeeInfo->update(['end_medical_insurance' => $this->end_medical_insurance]);
