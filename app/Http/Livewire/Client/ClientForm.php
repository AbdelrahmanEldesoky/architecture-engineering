...
class ClientForm extends BasicForm
{
    ...
    public function render()
    {
        ...
        $brokers = Broker::where('name', 'like', '%' . $this->brokerName . '%')->pluck('name', 'id')->toArray();        return view('livewire.client.client-form',compact('clients','branches','brokers'));
    }
