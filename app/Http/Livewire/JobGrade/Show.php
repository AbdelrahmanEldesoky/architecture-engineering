...
class Show extends BasicTable
{
    ...
    {
        $jobGrades = EmploymentData::with(['jobType','employee','employee.attachments','jobType.jobGrades','jobType.jobGrades.grade'])
                ->whereHas("jobType.jobGrades", function ($query){
                    $query->where('id',   $this->jobGradesId );
                })
    ...
    public function render()
    {
        ...
        return view('livewire.job-grade.show',compact('jobGrades','jobNamesSelect','JobTypes','JobPage'));
    }
