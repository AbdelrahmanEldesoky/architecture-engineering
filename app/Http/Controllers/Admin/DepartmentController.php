...
class DepartmentController extends MainController
{
    ...
    public function index(Request $request) {
        return view('admin.departments.index')->with(['branch_id'=>$request->branch_id,'management_id' => $request->management_id,'tree'=>$this->tree]);
    }
...
//        }
        ...
        return view('admin.departments.create')->with(['management_id' =>$request->management_id,'department_id'=>$request->department_id,'parent_type'=>$request->parent_type,'tree'=>$tree]);
    }
