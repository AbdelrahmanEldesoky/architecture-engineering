...
Route::group([
    ...
    Route::get('/', [\App\Http\Controllers\Admin\DashboardController::class, 'dashboard'])->name('dashboard')->middleware('end_date');
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::resource('/state', \App\Http\Controllers\Admin\Setting\StateController::class);
            Route::get('/date_end', [\App\Http\Controllers\Admin\Setting\DateEndController::class,'setting'])->name('date-end.index');
            Route::get('/date_end/create', [\App\Http\Controllers\Admin\Setting\DateEndController::class,'store'])->name('date_end.store');
...
Route::group([
    ...
    Route::group([
        ...
        Route::get('/', [\App\Http\Controllers\Admin\Api\ContractTaskController::class, 'index']);
        ...
        Route::post('/update/{id}', [\App\Http\Controllers\Admin\Api\ContractTaskController::class, 'update']);
        Route::post('/delete', [\App\Http\Controllers\Admin\Api\ContractTaskController::class, 'destroy']);
    });

    Route::group([
        'prefix' => 'payment',
    ], function () {
        Route::get('/', [\App\Http\Controllers\Admin\Api\ContractPaymentController::class, 'index']);
        ...
        Route::post('/update/{id}', [\App\Http\Controllers\Admin\Api\ContractPaymentController::class, 'update']);
        Route::post('/delete', [\App\Http\Controllers\Admin\Api\ContractPaymentController::class, 'destroy']);
    });

    Route::group([
        'prefix' => 'lever',
    ], function () {
        Route::get('/', [\App\Http\Controllers\Admin\Api\ContractLeverController::class, 'index']);
        ...
        Route::post('/update/{id}', [\App\Http\Controllers\Admin\Api\ContractLeverController::class, 'update']);
        Route::post('/delete', [\App\Http\Controllers\Admin\Api\ContractLeverController::class, 'destroy']);
    });
...
######################### End Api Dashboard   ################################################
    ...
    Route::get('job_types/{id}', [JobsController::class, 'showJobType'])->name('job_types.show');
    Route::get('job_names/{id}/{type}', [JobsController::class, 'showJobNames'])->name('job_names.show');
    Route::get('job_name/{id}', [JobsController::class, 'detailsJobNames'])->name('job_names.details');
    Route::get('job_grades/{id}', [JobsController::class, 'showJobGrade'])->name('job_grades.show');
    ...
    Route::resource('contracts', \Modules\Projects\Http\Controllers\ContractController::class);
    ...
    Route::get('depatmentTree', [\App\Http\Controllers\Admin\DepartmentTreeController::class, 'index'])->name('department-tree');
    Route::get('depatmentTreeDetails', [\App\Http\Controllers\Admin\DepartmentTreeController::class, 'detailsTree'])->name('details-department-tree');
    ...
    Route::get('get-employee-with-management-department/{branch_id}/{management_id?}/{department_id?}',[EmployeeController::class,'getEmployeeByBranchAndDepartmentAndManagement'])->name('get-employee-by-branch-and-department-and-management');
    ...
    Route::get('employee/reports', [ReportController::class, 'employees'])->name('employee.report');
