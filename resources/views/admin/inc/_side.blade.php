<div class="main-sidebar d-print-none">
    <div class="flex-shrink-0 p-3" style="width: 100%">
        ...
        <ul class="list-unstyled ps-0">
            ...
            @if (havePermissionTo('gada.agreements.view') ||
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle btn-icon rounded collapsed px-1 fw-semibold py-2"
                        ...
                        <i class="bx bx-sm bx-chevron-left"></i>
                        <span class="btn-icon">
                            <i class="bx bx-sm bx-door-open"></i>ش
                            {{ __('names.gada-gate') }}
                        </span>
                    </button>
            ...
            @if (havePermissionTo('attendance.view') ||
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse" id="attend-requests-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            @if (havePermissionTo('attendance.view'))
                                <li><a href="{{ route('admin.employee.report') }}"
                                       class="rounded">{{ __('names.employees-attendance') }}</a>
                                </li>
                            @endif
                            @if (havePermissionTo('attendance.requests.view'))
                                <li><a href="{{ asset('react/employees/requests') }}"
                                       class="rounded">{{ __('names.employees-requests') }}</a></li>
                            @endif
                            @if (havePermissionTo('attendance.requests.view'))
                                <li><a href="{{ asset('react/employees/procedures') }}"
                                       class="rounded">احراءات الطلبات </a></li>
                            @endif
            ...
            {{--            <li class="mb-1">--}}
            {{--                <button--}}
            {{--                  class="btn btn-toggle btn-icon rounded collapsed px-1 fw-semibold py-2"--}}
            ...
            {{--                  <i class="bx bx-sm bx-chevron-left"></i>--}}
            {{--                  <span class="btn-icon"--}}
            {{--                    ><i class="bx bx-sm bxs-server"></i>--}}
            {{--                    التقرير البياني--}}
            {{--                  </span>--}}
            {{--                </button>--}}
            {{--                <div class="collapse" id="home-collapse1">--}}
            {{--                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">--}}
            {{--                    <li><a href="{{route('admin.employee.report')}}" class="rounded">تقرير بالحضور</a></li>--}}
            {{--                  </ul>--}}
            {{--                </div>--}}
            {{--              </li>--}}
        </ul>
