    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @if (havePermissionTo('departments.create'))
                <a href="{{ route('admin.departments.create', ['management_id'=>$management_id,'department_id' => $department_id,'parent_type'=>2]) }}"
                ...
                <tbody>
                    @foreach ($departments as $key => $department)
                        <tr>
                            ...
                            <td>
                                {{ $department->manger?->employee->name }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ $department->management?->manger?->employee?->name }}
                            </td>

                            <td>
                                {{ $department->childrens()->count() }}
                            </td>
