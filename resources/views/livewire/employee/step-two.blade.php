                ...
                <div class="row">
                    ...
                    @foreach ($academic as $key => $grade)
                        <div
                            ...
                            <x-input-label :value="__('names.university_id')"></x-input-label><span style="color: red"> * </span>
                            <select
                        ...
                        <div
                            ...
                            <x-input-label :value="__('names.qualification')"></x-input-label><span style="color: red"> * </span>
                            <input
                        ...
                        <div
                            ...
                            <x-input-label :value="__('names.specialization')"></x-input-label><span style="color: red"> * </span>
                            <input
                        ...
                        <div
                            ...
                            <x-input-label :value="__('names.qualification-date')"></x-input-label><span style="color: red"> * </span>
                            <input type="date"
                        ...
                        <div class="col-md-4 form-group mb-3 ">
                            @if (count($academic) - 1 == $key || count($academic) == 1)
                                <button type="button" wire:click="addMoreGrades()" class="form-control btn btn-outline-primary mr-2 mt-3">
                                    {{ __('اضافة درجة علمية اخرى') }}
                                </button>
                            @endif
                        @if (count($academic) >= 2)
                            <button type="button"
                            ...
                            <div class="col-md-12 loading">
                                <table class="table table-borderless">
                                    <thead>
                                        ...
                                        <th> {{ __('تاريخ الحصول') }} </th>
                                        <th> {{ __('شهادة الدورة') }} </th>
                                        <th> {{ __('              ') }} </th>
                                    </thead>
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="">
                                                        <div class=" limit-2">
                                                            ...
                                                            <a href="#" class="px-1"
                                                                wire:click="destroyCourse('{{ $co['id'] }}')"
                                                                type="button">
                                                                <i class='bx bx-trash bx-sm text-danger'></i>
                                                            </a>
                                                        </div>
        ...
        <div class="modal-dialog modal-lg @if ($isloading) loading @endif">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn btn-outline-primary light" data-bs-dismiss="modal">X</button>
                </div>
