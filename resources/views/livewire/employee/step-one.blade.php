        ...
        <section class="step 1">
            ...
            <div class="section">
                <div class="user-image-upload">
                    <label class="create-user-image" id="userImageContainer">
                        ...
                        <a class="mt-2">
                            <i class='bx bxs-edit bx-sm text'></i>
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.first_name') is-invalid  @enderror">
                    <x-input-label :value="__('names.first-name')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.last_name') is-invalid  @enderror">
                    <x-input-label :value="__('names.last-name')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.phone') is-invalid  @enderror">
                    <x-input-label :value="__('names.phone')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.email') is-invalid  @enderror">
                    <x-input-label :value="__('names.email')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.end_id_number') is-invalid  @enderror">
                    <x-input-label value="تاريخ انتهاء الهوية"></x-input-label><span style="color: red"> * </span>
                    <input type="date" class="form-control " wire:model.lazy="info.end_id_number">
                    @error('info.end_id_number')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>

                <div class="col-md-4 form-group mb-3 @error('info.end_saudi_authority') is-invalid  @enderror">
                    <x-input-label :value="__('تاريخ انتهاء الهيئة السعودية')"></x-input-label><span style="color: red"> * </span>
                    <input type="date" class="form-control " wire:model.lazy="info.end_saudi_authority">
                    @error('info.end_saudi_authority')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    @if ($employee_id != null && $employee->attachments->where('type', 'id_number_photo')?->last()?->path !=null )

                        <x-upload model="id_number_photo" :file="$id_number_photo ?? null" :path="$info != null
                            ? url('/storage/' . $employee->attachments->where('type', 'id_number_photo')?->last()?->path)
                            : null" :original_name="$employee->attachments->where('type', 'id_number_photo')->value('original_name')"
                            :extension="$employee->attachments->where('type', 'id_number_photo')->value('extension')" :size="$employee->attachments->where('type', 'id_number_photo')->value('size')">
                        </x-upload>

                    @else
                        <x-upload model="id_number_photo" :file="$id_number_photo ?? null"></x-upload>
                    @endif


                    <div wire:loading wire:target="id_number_photo">{{ __('names.uploading') }}...</div>
                    @error('id_number_photo')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>

                <div class="col-md-4 form-group mb-3 @error('info.border_no') is-invalid  @enderror">
                    <x-input-label :value="__('names.border-no')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.passport_no') is-invalid  @enderror">
                    <x-input-label :value="__('names.passport')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.national_id') is-invalid  @enderror">
                    <x-input-label :value="__('names.national-id')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3">
                    @if ($employee_id != null  && $employee->attachments->where('type', 'border_photo')?->last()?->path)
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    @if ($employee_id != null && $employee->attachments->where('type', 'passport_photo')?->last()?->path !=null )
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    @if ($employee_id != null  && $employee->attachments->where('type', 'national_photo')?->last()?->path)
                ...
                {{-- <div class="col-md-4 form-group mb-3 @error('info.end_medical_insurance') is-invalid  @enderror">
                    <x-input-label value="تاريخ انتهاء التأمين الصحي"></x-input-label>
                    <input type="date" class="form-control " wire:model.lazy="info.end_medical_insurance">
                    @error('info.end_medical_insurance')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div> --}}
                ...
                <div class="col-md-4 form-group mb-3 @error('info.nationality') is-invalid  @enderror">
                    <x-input-label :value="__('names.nationality')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.gender') is-invalid  @enderror">
                    <x-input-label :value="__('الجنس')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.birth_date') is-invalid  @enderror">
                    <x-input-label :value="__('names.birthdate')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('info.bank_account') is-invalid  @enderror">
                    <x-input-label :value="__('رقم الحساب')"></x-input-label><span style="color: red"> * </span>
                    <input type="text" wire:model.lazy="info.bank_account" class="form-control" placeholder="{{ __('رقم الحساب') }}"/>
                    @error('employee.gender')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4 form-group mb-3 @error('info.bank_iban') is-invalid  @enderror">
                    <x-input-label :value="__('الايبان البنكي')"></x-input-label><span style="color: red"> * </span>
                    <input type="text" wire:model.lazy="info.bank_iban" class="form-control" placeholder="{{ __('رقم الايبان') }}"/>
                    @error('employee.gender')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4 form-group mb-3 @error('info.bank_name') is-invalid  @enderror">
                    <x-input-label :value="__('اسم البنك')"></x-input-label><span style="color: red"> * </span>
                    <input type="text" wire:model.lazy="info.bank_name" class="form-control" placeholder="{{ __('اسم البنك') }}"/>
                    @error('employee.gender')
                        <div class="message mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.country_id') is-invalid  @enderror">
                    <x-input-label :value="__('names.country')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.city_id') is-invalid  @enderror">
                    <x-input-label :value="__('المحافظة')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('employee.address') is-invalid  @enderror">
                    <x-input-label :value="__('names.address')"></x-input-label><span style="color: red"> * </span>
                ...
                <div class="col-md-4 form-group mb-3 @error('relative.full_name') is-invalid  @enderror">
                    <x-input-label :value="__('names.name')"></x-input-label><span style="color: red"> * </span>
