    ...
    <form action="#" wire:submit.prevent="save">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-3 form-group mb-4 @error('finance.salary') is-invalid @enderror">
                <x-input-label :value="__('المرتب الاساسي')"></x-input-label><span style="color: red"> * </span>
            ...
            <div class="col-md-3 form-group mb-4 @error('finance.work_days_in_week') is-invalid @enderror">
                <x-input-label :value="__('names.work-days-in-month')"></x-input-label><span style="color: red"> * </span>
            ...
            <div class="col-md-3 form-group mb-4 @error('finance.work_hours') is-invalid @enderror">
                <x-input-label :value="__('names.work-hours-in-day')"></x-input-label><span style="color: red"> * </span>
            ...
            <div class="modal-content">
                ...
                <form action="#" wire:submit.prevent="addDues" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="transfer_sponsership">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="checkbox" id="ch-180"
                                            wire:model.lazy="dues.transfer-sponsership.register-only" />
                                        <label for="ch-180"> {{ __('names.register-only') }} </label>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="medical_insurance">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="checkbox" id="ch-182"
                                            wire:model.lazy="dues.medical-insurance.family" />
                                        <label for="ch-182"> {{ __('names.family') }} </label>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label for="ch_9">
                                    {{ __('تاريخ انتهاء التأمين الطبي') }}
                                </label>
                                {{-- disabled readonly --}}
                                <input type="date" class="form-control" wire:model.lazy="end_medical_insurance" 
                                {{ isset($dues['medical-insurance']) && ($dues['medical-insurance'] ) ? '' : 'disabled' }} />
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary light" data-bs-dismiss="modal" onclick="closeModal()">
                            {{ __('names.close') }}
                        </button>
                        
                        <script>
                            function closeModal() {
                                window.location.href = "{{ route('admin.custom.create', ['employee_id' => $employee_id, 'step' => 4]) }}";
                            }
                        </script>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <x-input-label :value="__('names.hire-date')" required="true"></x-input-label>
                                    <input type="date" wire:model.lazy="vacation.date_of_hiring" disabled
                                        class="form-control" />
                                ...
                                <div
                                    ...
                                    <x-input-label :value="__('names.due-date')" required="true"></x-input-label>
