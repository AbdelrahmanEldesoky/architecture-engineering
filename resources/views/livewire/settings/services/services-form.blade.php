        ...
        <div class="section row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12 @error('files.' . $key . '.description') is-invalid @enderror">
                        ...
                        <x-textarea wire:model="files.{{ $key }}.description" :required="true" :value="0"
                    ...
                    <div class="col-md-2 d-flex align-content-center justify-content-center">
                        <div class="btn-group   " role="group" aria-label="First group" dir="ltr" style="margin-right: 70px">
                            @if ($loop->count == 1)
